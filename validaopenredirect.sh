...
echo -e
printf  "VALID REDIRECT 1.0 https://github.com/kauenavarroBR\n"
echo -e
...
case "$HTTP_CODE" in
    ...
    "307")
        echo -e "HOST \e[36m${url} \e[0m Status http => \e[32m${HTTP_CODE} \e[0m"
        var3=$(echo "$url" >> valid307.txt)
    ;;
    "308")
        echo -e "HOST \e[36m${url} \e[0m Status http => \e[32m${HTTP_CODE} \e[0m"
        var4=$(echo "$url" >> valid308.txt)
    ;;

    *)
        echo -e "HOST \e[36m${url} \e[0m Status http => \e[31m${HTTP_CODE} \e[0m"
        var5=$(echo "$url" >> outhers.txt)
    ;;
esac
...
var5=$(wc -l outhers.txt)
echo -e
echo -e "Were found 301 \e[36m${var1} \e[0m  302 \e[36m${var2} 307 \e[0m \e[36m${var3} \e[0m 308 \e[36m${var4} \e[0m valid  and  outhers \e[32m${var4} \e[0m invalid"
